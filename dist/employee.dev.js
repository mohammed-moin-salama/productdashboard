  ...
  $('#Employee').DataTable({
    ...
    columns: [{
      ...
      render: function render(data, type, row) {
        return "\n                            <div class=\"d-flex contant text-center justify-content-center\">\n                            <div class=\"d-flex flex-column \"> <button href=\"# \" class=\"btn view-btn \" onclick=\"viewEmp(".concat(data, ")\" data-bs-toggle=\"tooltip\" data-bs-placement=\"top\" title=\"View\"><i class=\"bx bx-show h5 \"></i></button>\n                            </div>\n                            <div class=\"d-flex flex-column \"> <button href=\"# \" class=\"btn edit-btn\" onclick=\" editEmp(").concat(data, ")\" data-bs-toggle=\"tooltip\" data-bs-placement=\"top\" title=\"Edit\"><i class=\"bx bx-edit h5\"></i></button>\n                            </div>\n                            <div class=\"d-flex flex-column \"> <button href=\"# \" class=\"btn delete-btn \" onclick=\"deleteEmp(").concat(data, ")\"data-bs-toggle=\"tooltip\" data-bs-placement=\"top\" title=\"Delete\"><i class=\"bx bx-trash h5\"></i></button>\n\n                            </div></div>\n                        ");
      }
    }]
  });
}
...
function viewEmp(id) {
  ...
  for (var index = 0; index < form1.elements["in"].length; index++) {
...
function AddEmp_01() {
  ...
  for (var _index = 0; _index < form1.elements["in"].length; _index++) {
    if (form1.elements["in"][_index].value > 0) {
      i = 1;
    }
  }
